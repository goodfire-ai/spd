...
from spd.utils.general_utils import get_device
...
def test_eval_metrics():
    ...
    test_configs = [
        {
            "name": "No eval metrics",
            "metrics": []
        },
        {
            "name": "Only CI_L0",
            "metrics": [{"classname": "CI_L0"}]
        },
        {
            "name": "Only CEandKLLosses", 
            "metrics": [{"classname": "CEandKLLosses", "extra_init_kwargs": {"rounding_threshold": 0.1}}]
        },
        {
            "name": "Only CIHistograms",
            "metrics": [{"classname": "CIHistograms"}]
        },
        {
