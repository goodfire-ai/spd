...
def create_metrics(
    ...
    unmasked_masks = {k: torch.zeros_like(v) for k, v in causal_importances.items()}
    unmasked_component_out = model.forward_with_components(batch, masks=unmasked_masks)
