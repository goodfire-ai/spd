...
from spd.metrics.stochastic_accuracy_layerwise import StochasticAccuracyLayerwise
...
def init_metric(
    ...
    match cfg:
        ...
        case StochasticAccuracyLayerwiseConfig():
            metric = StochasticAccuracyLayerwise(
                model=model,
                device=device,
                sampling=run_config.sampling,
                use_delta_component=run_config.use_delta_component,
