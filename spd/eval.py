...
class ActivationsAndInteractions(StreamingEval):  # TODO factorize compute function
    ...
    def compute(self) -> Mapping[str, Image.Image]:
        ...
        for module_name in self.model.components:
            ...
            component_co_activation_fractions_fig = plot_single_layer_component_co_activation_fractions(
                module_name, alive_co_activation_fractions[module_name]
            )
            results[f"figures/component_co_activation_fractions/{module_name}"] = component_co_activation_fractions_fig
            ...
            results[f"figures/component_abs_left_singular_vectors_geometric_interaction_strengths/{module_name}"] = geometric_interaction_strengths_fig

            # Create individual geometric interaction strength vs coactivation plot for this layer
            geom_int_strength_vs_coact_fig = plot_single_layer_geometric_interaction_strength_vs_coactivation(
                module_name, 
                alive_geometric_interaction_strength_matrices_flattened[module_name],
                alive_co_activation_fractions_flattened[module_name]
            )
            results[f"figures/geometric_interaction_strength_vs_coactivation/{module_name}"] = geom_int_strength_vs_coact_fig
            ...
            results[f"figures/geometric_interaction_strength_product_with_coactivation_fraction/{module_name}"] = geom_int_strength_product_with_coact_fig
