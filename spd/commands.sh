...
spd-run --experiments ss_llama_sans_base,ss_llama_subset_bal_sans,ss_llama_subset_sans  --sweep min_sweep_params.yaml  --dp 4


spd-run --experiments ss_llama_subset_sans_bal_simple,ss_llama_sans_bal  --dp 4
