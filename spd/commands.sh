...
#102964_1
spd-run --experiments ss_llama_subset_recon_0p25_0p5 --dp 4

#102965
spd-run --experiments ss_llama_l0_balance --sweep l0_balance_subset_sweep.yaml --n-agents 12

#103164_1 
spd-run --experiments ss_llama_nh_yolo1 --dp 8

#103165_1
spd-run --experiments ss_llama_nh_yolo2 --dp 4