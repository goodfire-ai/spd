...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    ...
    "pile_llama_simple_mlp-4L-finetune-pgd": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/pile_llama_simple_mlp-4L-finetune-pgd.yaml"),
        expected_runtime=10000,
    ),
}
