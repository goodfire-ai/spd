...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    ...
    "tms_5-2-cpgd": ExperimentConfig(
        task_name="tms",
        decomp_script=Path("spd/experiments/tms/tms_decomposition.py"),
        config_path=Path("spd/experiments/tms/tms_5-2-cpgd_config.yaml"),
        expected_runtime=4,
    ),
    ...
    "resid_mlp1-cpgd": ExperimentConfig(
        task_name="resid_mlp",
        decomp_script=Path("spd/experiments/resid_mlp/resid_mlp_decomposition.py"),
        config_path=Path("spd/experiments/resid_mlp/resid_mlp1-cpgd_config.yaml"),
        expected_runtime=5,
    ),
    ...
    "ss_llama_simple-1L-cpgd": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/ss_llama_simple-1L-cpgd.yaml"),
        expected_runtime=180,
    ),
    ...
    "continuous_pgd": ExperimentConfig(
        task_name="lm",
        decomp_script=Path("spd/experiments/lm/lm_decomposition.py"),
        config_path=Path("spd/experiments/lm/continuous_pgd_config.yaml"),
        expected_runtime=1600,
    ),
    "ts": ExperimentConfig(
        task_name="lm",
