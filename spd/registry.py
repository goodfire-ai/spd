...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    "tms_5-2": ExperimentConfig(
        ...
        expected_runtime=4,
        canonical_run="wandb:goodfire/spd/runs/f187761i",
    ),
    "tms_5-2-id": ExperimentConfig(
        ...
        expected_runtime=4,
        canonical_run="wandb:goodfire/spd/runs/dan1p38k",
    ),
    "tms_40-10": ExperimentConfig(
        ...
        expected_runtime=5,
        canonical_run="wandb:goodfire/spd/runs/77qnmzzw",
    ),
    "tms_40-10-id": ExperimentConfig(
        ...
        expected_runtime=5,
        canonical_run="wandb:goodfire/spd/runs/ccrfz8kb",
    ),
    "resid_mlp1": ExperimentConfig(
        ...
        expected_runtime=3,
        canonical_run="wandb:goodfire/spd/runs/m5bokfuu",
    ),
    "resid_mlp2": ExperimentConfig(
        ...
        expected_runtime=5,
        canonical_run="wandb:goodfire/spd/runs/9s8gky0w",
    ),
