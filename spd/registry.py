...
EXPERIMENT_REGISTRY: dict[str, ExperimentConfig] = {
    "tms_5-2": ExperimentConfig(
        ...
        expected_runtime=4,
        canonical_run="wandb:goodfire/spd/runs/9igruzrm",
    ),
    "tms_5-2-id": ExperimentConfig(
        ...
        expected_runtime=4,
        canonical_run="wandb:goodfire/spd/runs/74t91zf8",
    ),
    "tms_40-10": ExperimentConfig(
        ...
        expected_runtime=5,
        canonical_run="wandb:goodfire/spd/runs/jeue56p9",
    ),
    "tms_40-10-id": ExperimentConfig(
        ...
        expected_runtime=5,
        canonical_run="wandb:goodfire/spd/runs/wtrljpqh",
    ),
    "resid_mlp1": ExperimentConfig(
        ...
        expected_runtime=3,
        canonical_run="wandb:goodfire/spd/runs/sbh1iamg",
    ),
    "resid_mlp2": ExperimentConfig(
        ...
        expected_runtime=11,
        canonical_run="wandb:goodfire/spd/runs/yxid3zki",
    ),
    "resid_mlp3": ExperimentConfig(
        ...
        expected_runtime=60,
        canonical_run="wandb:goodfire/spd/runs/45c2shur",  # A few imperfections in layers 0 and 1
    ),
