...
class Harvester:
    ...
    def _collect_activation_examples(
        ...
        print(f"    Time taken to subsample firings: {-(t - (t := perf_counter())):.2f} seconds")
        ...
        print(f"    Time taken to pad ci: {-(t - (t := perf_counter())):.2f} seconds")
        ...
        print(f"    Time taken to expand indices: {-(t - (t := perf_counter())):.2f} seconds")
    ...
    def add_activation_examples(
        ...
        ci_windows_list: list[list[float]],
    ) -> None:
