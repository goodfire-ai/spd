...
if __name__ == "__main__":
    from spd.harvest.schemas import ActivationExample, SubcompActStats
    ...
    component = ComponentData(
        ...
        activation_examples=[
            ActivationExample(
                ...
                inner_acts=[0.5, 0.0, 1.2, 0.0, 0.0],
            )
        ],
        ...
        subcomp_act_stats=SubcompActStats(mean=0.5, std=0.2, min=0.0, max=1.2),
    )
    arch = ArchitectureInfo(
        model_class="GPT-2",
        n_blocks=12,
