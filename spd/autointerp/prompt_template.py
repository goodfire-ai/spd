...
def format_prompt_template(
    ...
    input_section = _build_input_section(input_token_stats)
    output_section = _build_output_section(output_token_stats, output_precision_top_k)
...
def _build_input_section(input_stats: TokenPRLift) -> str:
...
def _build_output_section(output_stats: TokenPRLift, top_k: int) -> str:
