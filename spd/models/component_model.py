...
try:
    from spd.models.extended_hooks import ExtendedHookManager, HookConfig
    _extended_hooks_available = True
except ImportError:
...
class ComponentModel(LoadableModule):
    ...
    def get_extended_hook_manager(self, hook_config: Any = None) -> Any:  # ExtendedHookManager, but avoiding forward reference issues
