...
class ComponentModel(LoadableModule):
    ...
    def forward(
        self,
        *args: Any,
        mode: Literal["target", "components", "pre_forward_cache", "pre_forward_cache_components"] | None = "target",
        ...
        **kwargs: Any,
        ...
        if mode == "components":
            ...
            assert mask_infos is not None, "mask_infos are required for mode='pre_forward_cache_components'"
            assert module_names is not None, (
    ...
    def _forward_with_pre_forward_cache_components_hooks(
        self, *args: Any, mask_infos: dict[str, ComponentsMaskInfo], module_names: list[str], **kwargs: Any
    ) -> tuple[Any, dict[str, Tensor]]:
