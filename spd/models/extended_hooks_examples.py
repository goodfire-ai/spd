...
from spd.models.extended_hooks import HookConfig, ExtendedHookManager
...
def basic_usage_example():
    ...
    target_outputs = captured_data['target_outputs']
    component_inner_acts = captured_data['component_inner_acts']
    ci_fn_outputs = captured_data['ci_fn_outputs']
    causal_importances = captured_data['causal_importances']
    residmlp_pre_activations = captured_data.get('residmlp_pre_activations', {})
    final_output = captured_data['final_output']
...
def magnitude_sweep_replacement_example():
    ...
    for step_idx in range(n_steps):
        ...
        for layer_name in layer_names:
            ...
            if layer_name in captured_data['component_inner_acts']:
                gate_inputs[layer_name][step_idx] = captured_data['component_inner_acts'][layer_name][0]
