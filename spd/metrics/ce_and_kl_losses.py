...
class CEandKLLosses(Metric):
    ...
    def _calc_ce_and_kl_losses(
        ...
        ci_masked_logits = self.model(batch, mask_infos=ci_mask_infos)[0]
        ...
        stoch_masked_logits = self.model(batch, mask_infos=mask_infos)[0]
        ...
        unmasked_logits = self.model(batch, mask_infos=nonmask_infos)[0]
        ...
        random_masked_logits = self.model(batch, mask_infos=rand_mask_infos)[0]
        ...
        rounded_masked_logits = self.model(batch, mask_infos=rounded_mask_infos)[0]
        ...
        zero_masked_logits = self.model(batch, mask_infos=zero_mask_infos)[0]
