"""(Embedding layer of) Language Model decomposition script.

This is a hacky implementation that just does the decomposition on the embedding layer by itself.
"""
...
import fire
from simple_stories_train.models.gpt2_simple import torch
import wandb
...
def main(
    ...
    target_model.eval()
    def fwd(x: Any) -> Any:
        return target_model.model.embed_tokens(x)
    target_model.forward = fwd
