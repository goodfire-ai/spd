...
class TMSAnalyzer:
    ...
    def compute_cosine_similarities(
        ...
        ).target_weight.T  # (n_features, n_hidden)  # pyright: ignore[reportInvalidCast]
...
class TMSPlotter:
    ...
    def get_analysis_summary(self) -> dict[str, float]:
        ...
        ).target_weight.T  # pyright: ignore[reportInvalidCast]
