...
To run:
    ...
    streamlit run spd/experiments/lm/streamlit_v1/app.py -- --model_path "wandb:spd/runs/snq4ojcy"

The app supports loading models from the UI. You can paste:
- Full WandB URLs: https://wandb.ai/goodfire/spd/runs/snq4ojcy
- WandB paths: wandb:spd/runs/snq4ojcy
