...
def optimize(
    ...
    prof = torch.profiler.profile(
        ...
        on_trace_ready=torch.profiler.tensorboard_trace_handler('/mnt/polished-lake/home/oli/spd/tb_log'),
        record_shapes=True,
        profile_memory=True,
        with_stack=True
    )

    # sanity check: log the full path of "./tb_log"
    logger.info(f"TensorBoard log directory: {Path('/mnt/polished-lake/home/oli/spd/tb_log').resolve()}")
