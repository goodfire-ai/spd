...
def get_activation_scales(
    ...
    while n_examples_seen < n_examples:
        ...
        # n_examples_seen += norms.numel()  # pyright: ignore[reportPossiblyUnboundVariable]

    del batch  # pyright: ignore[reportPossiblyUnboundVariable]
    del cache  # pyright: ignore[reportPossiblyUnboundVariable]
    gc.collect()
    torch.cuda.empty_cache()
