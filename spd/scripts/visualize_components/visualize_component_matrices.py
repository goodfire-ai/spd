...
def analyze_component_behavior(
    ...
    for module_name, ci in causal_importances.items():
        ...
        print(f"  Top 10 most active components:")
        for i, stats in enumerate(component_stats[:10]):
            c = stats['component']
        ...
        for count, freq in zip(unique_counts.tolist(), counts.tolist()):
