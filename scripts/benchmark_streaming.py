...
def main():
    ...
    print(f"  Min/Max:     {precached_results['min_step_ms']:.2f} / {precached_results['max_step_ms']:.2f} ms")
    ...
    print(f"  Min/Max:     {streaming_results['min_step_ms']:.2f} / {streaming_results['max_step_ms']:.2f} ms")
