...
def main():
    ...
    print(f"  Speed: {n_examples / dl_time:.0f} examples/s, {total_chars / dl_time / 1e6:.1f}M chars/s")
    print()
    ...
    print(f"  {N_BATCHES} batches in {combined_time:.2f}s ({combined_time / N_BATCHES * 1000:.1f}ms/batch)")
    print()
