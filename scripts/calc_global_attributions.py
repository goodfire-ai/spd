...
class TransformerBlockPaths:
    def __init__(self, base: str, q: str, k: str, v: str, o: str, mlp_in: str, mlp_out: str):
        self.q = q
        self.k = k
        self.v = v
        self.o = o
...
class TransformerPaths:
    ...
    def block(self, block_idx: int) -> "TransformerBlockPaths":
        base = f"{self._base_path}.{self._blocks_name}.{block_idx}"
        return TransformerBlockPaths(
            base, self.q, self.k, self.v, self.o, self.mlp_in, self.mlp_out
        )

    @staticmethod
    def gpt2_small() -> "TransformerPaths":
