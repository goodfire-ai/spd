...
from spd.eval import CIHistograms, ActivationsAndInteractions
...
class TestActivationsAndInteractions:
    ...
    def test_individual_layer_plots(self, mock_model: Mock, mock_config: Mock, sample_ci: dict[str, torch.Tensor]):
        ...
        with patch("spd.eval.plot_single_layer_component_co_activation_fractions") as mock_co_act_plot, \
             patch("spd.eval.plot_single_layer_component_abs_left_singular_vectors_geometric_interaction_strengths") as mock_geom_plot, \
             patch("spd.eval.plot_single_layer_geometric_interaction_strength_vs_coactivation") as mock_scatter_plot, \
             patch("spd.eval.plot_single_layer_geometric_interaction_strength_product_with_coactivation_fraction") as mock_product_plot:
