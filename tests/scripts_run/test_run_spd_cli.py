...
@pytest.mark.parametrize(
    ...
    [
        ...
        # Example 9: Run with data parallelism over 2 nodes x 4 GPUs
        (
            ["--experiments", "ss_mlp", "--dp-nodes", "2", "--dp-gpus-per-node", "4"],
            {
                "experiments": "ss_mlp",
                "sweep": False,
                "n_agents": None,
        ...
        # Example 10: Explicitly set dp world size via --dp
        (
