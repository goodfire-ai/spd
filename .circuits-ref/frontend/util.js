window.util = (function () {
  ...
  async function getFile(path) {
    ...
    // If path starts with /, treat as relative to local server
    // (Original: path = 'https://transformer-circuits.pub/2025/attribution-graphs' + path)
    if (path.startsWith('/')) {
      path = '.' + path  // Use local files
    }
