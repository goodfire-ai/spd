#!/usr/bin/env python3
"""Extract structured findings from all existing investigations using Claude."""
...
async def extract_structured_findings(agent_reasoning: str) -> dict:
    """Use Claude to extract structured findings from agent reasoning."""
...
async def process_investigation(investigation_path: Path) -> bool:
    ...
    print(f"  Extracting from {len(agent_reasoning)} chars of reasoning...")
