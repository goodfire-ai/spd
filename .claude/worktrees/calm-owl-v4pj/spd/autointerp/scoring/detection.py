...
from spd.autointerp.config import AnthropicBatchConfig, DetectionEvalConfig, OpenRouterConfig
...
) -> tuple[defaultdict[str, list[DetectionTrial]], defaultdict[str, int]]:
